...
(function() {
  ...
  AwsS3Form = (function(superClass) {
    ...
    AwsS3Form.prototype.create = function(filename, options) {
      var _cDisposition, _cType, _data, _host, _policyB64, _secure, _signature, data;
      if (options == null) {
        options = {};
      }
      ...
      _data = {
        ...
        contentLengthRange: options.contentLengthRange || this.config.contentLengthRange
      };
      if (options.serverSideEncryption != null) {
        _data["x-amz-server-side-encryption"] = options.serverSideEncryption;
      }
      if ((options.redirectUrlTemplate != null) || (options.redirectUrl != null)) {
      ...
      if (options.host != null) {
        ...
        _host = "s3-" + this.config.region + ".amazonaws.com/" + this.config.bucket;
      }
      data = {
        action: (_secure ? "https" : "http") + "://" + _host,
        filefield: "file",
        fields: {
      ...
      if ((options.redirectUrlTemplate != null) || options.redirectUrl) {
        if (options.redirectUrlTemplate != null) {
    ...
    AwsS3Form.prototype.policy = function(filename, options, _predef) {
      ...
      if (_predef.success_action_status != null) {
        ...
        if (options.redirectUrlTemplate != null) {
          ...
          policy.conditions.push({
            "success_action_redirect": _predef.success_action_redirect || options.redirectUrl
          });
        }
      }
